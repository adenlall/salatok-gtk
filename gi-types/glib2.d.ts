...
export function log_writer_default_set_debug_domains(domains: string): void;
...
export function win32_check_windows_version(major: number, minor: number, spver: number, os_type: Win32OSType): boolean;
export function win32_error_message(error: number): string;
export function win32_ftruncate(f: number, size: number): number;
export function win32_get_command_line(): string[];
export function win32_get_package_installation_directory(_package?: string | null, dll_name?: string | null): string;
export function win32_get_package_installation_directory_of_module(hmodule?: any | null): string;
export function win32_get_package_installation_subdirectory(
    _package: string | null,
    dll_name: string | null,
    subdir: string
): string;
export function win32_get_windows_version(): number;
export function win32_getlocale(): string;
export function win32_locale_filename_from_utf8(utf8filename: string): string;
...
export namespace Win32OSType {
    export const $gtype: GObject.GType<Win32OSType>;
}

export enum Win32OSType {
    ANY = 0,
    WORKSTATION = 1,
    SERVER = 2,
}
