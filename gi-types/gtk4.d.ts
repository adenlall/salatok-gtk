...
export class DropDown extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    get searchMatchMode(): StringFilterMatchMode;
    set searchMatchMode(val: StringFilterMatchMode);
    get selected(): number;
...
export class FileLauncher extends GObject.Object {
    ...
    get alwaysAsk(): boolean;
    set alwaysAsk(val: boolean);
    get file(): Gio.File;
    set file(val: Gio.File);
...
export class PrintDialog extends GObject.Object {
    ...
    get_title(): string;
    print(parent?: Window | null, setup?: PrintSetup | null, cancellable?: Gio.Cancellable | null): void;
    print_file(
        parent: Window | null,
    ...
    print_finish(result: Gio.AsyncResult): Gio.OutputStream | null;
    set_accept_label(accept_label: string): void;
    set_modal(modal: boolean): void;
    set_page_setup(page_setup: PageSetup): void;
    set_print_settings(print_settings: PrintSettings): void;
    set_title(title: string): void;
    setup(parent?: Window | null, cancellable?: Gio.Cancellable | null): void;
    setup_finish(result: Gio.AsyncResult): PrintSetup | null;
}
...
export class Video extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    get graphicsOffload(): GraphicsOffloadEnabled;
    set graphicsOffload(val: GraphicsOffloadEnabled);
    get loop(): boolean;
    set loop(val: boolean);
    get media_stream(): MediaStream;
    set media_stream(val: MediaStream);
