...
export class Store {
    ...
    setup() {
        ...
        let ff = Gio.File.new_for_path(GLib.build_filenamev([GLib.get_user_config_dir(), "user.json"]));
    ...
    #write_File_to_local_dir(GFile, file) {
        this.#mkdir('quran');
        let dist = Gio.File.new_for_path(GLib.build_filenamev([GLib.get_user_config_dir(), "quran", file]));
